...
require (
	...
	github.com/openshift/origin v1.5.0-alpha.3.0.20260202203259-8acddbb71da3
)
...
require (
	...
	github.com/openshift/cluster-network-operator v0.0.0-20240112173225-45bc1ab8881c // indirect
